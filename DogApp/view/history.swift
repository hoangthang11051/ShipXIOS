...
class history: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func loadWorking(){
        ...
        Alamofire.request("http://shipx.vn/api/index.php/VinterGetOrders/?hero_id=\(heroID)&status=8&start_date=24-06-2018&end_date=\(DateWorking)&start=\(soTrang)",headers: headers).responseJSON {(response) in
